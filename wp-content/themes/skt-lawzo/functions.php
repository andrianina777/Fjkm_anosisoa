...
define('SKT_URL','https://www.sktthemes.org', 'skt-lawzo');
define('SKT_THEME_URL','https://www.sktthemes.org/themes', 'skt-lawzo');
define('SKT_THEME_DOC','http://sktthemesdemo.net/documentation/lawzo-documentation/', 'skt-lawzo');
define('SKT_PRO_THEME_URL','https://www.sktthemes.org/shop/lawzo-lawyer-wordpress-theme/', 'skt-lawzo');
