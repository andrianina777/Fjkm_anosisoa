...
if ( ! defined( 'GALLERY_MASTER_WIZARD_VERSION_NUMBER' ) ) {
	define( 'GALLERY_MASTER_WIZARD_VERSION_NUMBER', '2.0.16' );
}
...
function gallery_master_action_links( $plugin_link ) {
	$plugin_link[] = '<a href="https://tech-banker.com/gallery-master/" style="color: red; font-weight: bold;" target="_blank">Go Pro!</a>';
	return $plugin_link;
}
/**
